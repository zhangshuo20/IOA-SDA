...
for i=1:length(guangdong)       
    ...
    s1=xlswrite('.\广东CO2-SDA\results_new.xlsx',result,sheetname{i},'W3:Z44');% 将sEa_chaining的结果写入到文件对应位置   
end

s2=xlswrite('.\广东CO2-SDA\results_new.xlsx',Ea_DL_Gosh,'SDA-LMDI&DL','D38:G49');% 将Ea_DL的结果写入到文件对应位置 
s3=xlswrite('.\广东CO2-SDA\results_new.xlsx',Ea_DL_chaining_Gosh,'SDA-LMDI&DL','L38:O49');% 将Ea_DL_chaining的结果写入到文件对应位置
s2=xlswrite('.\广东CO2-SDA\results_new.xlsx',Ea_LMDI_Gosh,'SDA-LMDI&DL','D54:G65');% 将Ea_LMDI的结果写入到文件对应位置
s3=xlswrite('.\广东CO2-SDA\results_new.xlsx',Ea_LMDI_chaining_Gosh,'SDA-LMDI&DL','L54:O65');% 将Ea_LMDI_chaining的结果写入到文件对应位置
