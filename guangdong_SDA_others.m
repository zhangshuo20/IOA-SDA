...
for i=1:length(guangdong_EEIO_2000_2015)       
    ...
    s1=xlswrite('.\广东CO2-SDA\results_SO2.xlsx',result,sheetname{i},'L3:Q45');% 将sEa_chaining的结果写入到文件对应位置   
end

s2=xlswrite('.\广东CO2-SDA\results_SO2.xlsx',Ea_DL,'SDA-LMDI&DL','D9:I15');% 将Ea_DL的结果写入到文件对应位置 
s3=xlswrite('.\广东CO2-SDA\results_SO2.xlsx',Ea_DL_chaining,'SDA-LMDI&DL','N9:S15');% 将Ea_DL_chaining的结果写入到文件对应位置
s2=xlswrite('.\广东CO2-SDA\results_SO2.xlsx',Ea_LMDI,'SDA-LMDI&DL','D25:I31');% 将Ea_LMDI的结果写入到文件对应位置
s3=xlswrite('.\广东CO2-SDA\results_SO2.xlsx',Ea_LMDI_chaining,'SDA-LMDI&DL','N25:S31');% 将Ea_LMDI_chaining的结果写入到文件对应位置
