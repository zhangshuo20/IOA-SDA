...
for i=1:length(guangdong)       
    ...
    s1=xlswrite('.\广东CO2-SDA\results.xlsx',result,sheetname{i},'L3:Q45');% 将sEa_chaining的结果写入到文件对应位置   
end

s2=xlswrite('.\广东CO2-SDA\results.xlsx',Ea_DL,'SDA-LMDI&DL','D4:I15');% 将Ea_DL的结果写入到文件对应位置 
s3=xlswrite('.\广东CO2-SDA\results.xlsx',Ea_DL_chaining,'SDA-LMDI&DL','N4:S15');% 将Ea_DL_chaining的结果写入到文件对应位置
s2=xlswrite('.\广东CO2-SDA\results.xlsx',Ea_LMDI,'SDA-LMDI&DL','D20:I31');% 将Ea_LMDI的结果写入到文件对应位置
s3=xlswrite('.\广东CO2-SDA\results.xlsx',Ea_LMDI_chaining,'SDA-LMDI&DL','N20:S31');% 将Ea_LMDI_chaining的结果写入到文件对应位置
