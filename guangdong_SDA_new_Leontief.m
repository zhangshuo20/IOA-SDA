...
for i=1:length(guangdong)       
    ...
    s1=xlswrite('C:\Users\yuyd\Desktop\广东CO2-SDA\results_new.xlsx',result,sheetname{i},'R3:U44');% 将sEa_chaining的结果写入到文件对应位置   
end

s2=xlswrite('C:\Users\yuyd\Desktop\广东CO2-SDA\results_new.xlsx',Ea_DL_Leontief,'SDA-LMDI&DL','D4:G15');% 将Ea_DL的结果写入到文件对应位置 
s3=xlswrite('C:\Users\yuyd\Desktop\广东CO2-SDA\results_new.xlsx',Ea_DL_chaining_Leontief,'SDA-LMDI&DL','L4:O15');% 将Ea_DL_chaining的结果写入到文件对应位置
s2=xlswrite('C:\Users\yuyd\Desktop\广东CO2-SDA\results_new.xlsx',Ea_LMDI_Leontief,'SDA-LMDI&DL','D20:G31');% 将Ea_LMDI的结果写入到文件对应位置
s3=xlswrite('C:\Users\yuyd\Desktop\广东CO2-SDA\results_new.xlsx',Ea_LMDI_chaining_Leontief,'SDA-LMDI&DL','L20:O31');% 将Ea_LMDI_chaining的结果写入到文件对应位置
