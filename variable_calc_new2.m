function [EPI, L, pf, G, pv, pop]=variable_calc_new2(Z,V,F,EP,pop)
% variable_calc_new函数用于计算结构分解的4个变量，环境压力计算公式为 EP=EPI*L*pf*pop; 
% 注意：F的列为1，V的行为1。否则计算出错
