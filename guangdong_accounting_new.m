...
%     s1=xlswrite('.\广东CO2-SDA\results_new.xlsx',result,sheetname{i},'C3:P44');% 将result写入到文件中
%     
% end
...
for i=3:length(guangdong)    
    ...
    result= [title; data_cell];                         % 将变量名称和数值组集到result
    s1=xlswrite('.\广东CO2-SDA\results_new.xlsx',result,sheetname{i},'C3:O44');% 将result写入到文件中
